...
9.  Discuss with the two sets of Deal Representative(s) the clauses. Note that in an Open Proposal anyone can connect with their address and discuss the clauses. Whereas in a Partnered Deal only Proposal Lead and Deal Representative(s) can, regardless of whether the deal is public or private.
