...
Here is an high-level summary of the most relevant steps in a Token Swap. For an in-depth walkthrough and for a more clear differentiation between Open Proposals and Partnered Deals, please refer to the relevant step-by-step tutorials <a href="/documentation/InitiateandconductaTokenSwap" router-ignore>here</a>.
...
4. Decide whether you want to keep private or publicly accessible the details of a deal, please see <a href="/documentation/TokenSwapFAQ#privacy" router-ignore>here</a> for a detailed description of how privacy settings work. In the case of a Partnered Deal, this will make public or private the whole deal. In the case of an Open Proposal, this setting will make public or private only the incoming offers.
